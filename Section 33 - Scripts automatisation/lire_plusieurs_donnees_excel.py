# 235
# Lire les données de plusieurs fichiers

import openpyxl

wb1 = openpyxl.load_workbook("octobre.xlsx", data_only=True) # data_only permet de récup seulement les valeurs
...
for i in donnees.items():
    ...
    for c in range(0, len(ventes)):
        sheet.cell(row, 2+c).value = ventes[c]
